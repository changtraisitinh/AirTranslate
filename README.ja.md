...
| モード | 適した用途 | 詳細 |
| --- | --- | --- |
| Apple標準モード | ローカル寄りの文字起こしと翻訳 | Apple Speechで文字起こしし、Apple Translationで選択した言語ペアを翻訳します。Apple標準モードは可能な場合、元言語を自動検出します。 |
...
- [AirTranslate-1.3.0.zipをダウンロード](https://github.com/himomohi/AirTranslate/releases/latest/download/AirTranslate-1.3.0.zip)
