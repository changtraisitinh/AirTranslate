...
- 저장된 기록 편집창의 Apple Intelligence 글쓰기 도구 버튼
...
저장소 편집 영역의 반짝이 버튼은 macOS Apple Intelligence Writing Tools를 열어 선택한 저장본을 시스템 글쓰기 도구로 교정하거나 다시 쓸 수 있게 합니다. 저장소 관리 창의 `모두 지우기` 버튼은 확인 절차를 거친 뒤 저장된 기록 파일 전체를 삭제합니다.
