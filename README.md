...
앱의 저장소 영역에서 기록을 선택하면 내용을 확인하고 수정할 수 있습니다. 필요 없는 기록은 앱에서 삭제할 수 있고, 폴더 버튼으로 Finder에서 저장 폴더를 바로 열 수 있습니다.
...
8. 저장소 영역이나 Finder에서 저장된 텍스트 파일을 확인합니다.
...
- `SidebarView`: 캡처 제어, 언어 선택, 모델 선택, 저장된 기록 편집 UI를 제공합니다.
