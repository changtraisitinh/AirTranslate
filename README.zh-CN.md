...
| 模式 | 适用场景 | 说明 |
| --- | --- | --- |
| Apple 默认模式 | 本地优先的转写和翻译 | 使用 Apple Speech 转写，并用 Apple Translation 翻译所选语言对。Apple 默认模式在可识别时会自动检测原文语言。 |
...
- [下载 AirTranslate-1.3.0.zip](https://github.com/himomohi/AirTranslate/releases/latest/download/AirTranslate-1.3.0.zip)
