...
| 모드 | 적합한 경우 | 설명 |
| --- | --- | --- |
| Apple 기본 모드 | 로컬 중심 전사와 번역 | Apple Speech로 전사하고 Apple Translation으로 선택한 언어쌍을 번역합니다. Apple 기본 모드는 가능한 경우 원문 언어를 자동 감지합니다. |
...
- [AirTranslate-1.3.0.zip 다운로드](https://github.com/himomohi/AirTranslate/releases/latest/download/AirTranslate-1.3.0.zip)
